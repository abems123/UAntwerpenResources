...
public:
    ...
    vector<Production*> getProductions1() const;
    void setProductions(const vector<Production*>& productions);
    string getStartVariable() const;
    void setStartVariable(const string& start_variable);
    ...
    pair<string, bool> hasUniqueProduction(const string& a) const;
