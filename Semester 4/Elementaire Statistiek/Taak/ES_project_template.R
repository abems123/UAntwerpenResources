# Project Elementaire Statistiek 2026
# Vervang hieronder 0123456789 door je eigen studentennummer.

studentennummer <- 20246031
alpha <- 0.01

# Data inladen en persoonlijke steekproeven nemen
...
# Alle uitvoer komt ook in een tekstbestand terecht.
